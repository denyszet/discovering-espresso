package com.example.android.architecture.blueprints.todoapp.test.essentials.l8_espressouiautomator
...
class UiAutomatorUiWatcherTest {
    ...
    fun dismissesStatisticsDialogUsingWatcher() {
        ...
        uiDevice.findObject(
                ...
                .getChild(UiSelector().className(ImageButton::class.java))
                .click()
